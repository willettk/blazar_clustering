...
class CatalogMatcher(object):
    ...
    def matchCats(self,bzb,fermi):
        ...
        print "number of objects:", len(name_fermi)
        ...
        for name,ned in ned_names.iteritems():
            if ned in name_fermi or ned in name_fermi2:
                c3fgl_name+=1
                print "found bzb match to fermi_assoc_field:", ned
            elif ned in ned_names_fermi.values():
                cfermi_ned+=1
                print "found bzb match to fermi-ned query:", ned
            else:
