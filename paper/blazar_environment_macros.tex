...
\newcommand{\myemail}{{\tt willett@physics.umn.edu}}
\newcommand{\neII}{[Ne{\small~II]}}
\newcommand{\neIII}{[Ne{\small~III]}}
\newcommand{\sIII}{[S{\small~III]}}
\newcommand{\sIV}{[S{\small~IV]}}
\newcommand{\arIII}{[Ar{\small~III]}}
\newcommand{\clII}{[Cl{\small~II]}}
\newcommand{\neV}{[Ne{\small~V]}}
\newcommand{\feII}{[Fe{\small~II]}}
\newcommand{\oIV}{[O{\small~IV]}}
\newcommand{\siII}{[Si{\small~II]}}
\newcommand{\arII}{[Ar{\small~II]}}
...
\newcommand{\vt}{$v_t$}
\newcommand{\uv}{$(u,v)$}
\newcommand{\lohmax}{$L_{OH}^{max}$}
\newcommand{\lohpred}{$L_{OH}^{pred}$}
